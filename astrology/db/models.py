...
class Sign(Base):
    ...
    adverb = Column(String(100), nullable=True)
...
class House(Base):
    ...
    type_ = Column(String(20), nullable=True)
    description = Column(Text, nullable=True)
...
class Aspect(Base):
    ...
    symbol = Column(String(10), nullable=True)
    type_ = Column(String(30), nullable=True)
    summary_keyphrase = Column(String(255), nullable=True)
...
class PlanetSignInterpretation(Base):
    ...
    keywords = Column(String(500), nullable=True)
    retrograde_interpretation = Column(Text, nullable=True)
